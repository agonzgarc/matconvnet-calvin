function [boxes, blobIndIm, blobIndBoxes, hierarchy] = selective_search_boxes_min(im, fast_mode, im_width, minBoxWidth)
% Girshick Wrapper
%
...
if ~exist('minBoxWidth', 'var') || isempty(minBoxWidth)
    minBoxWidth = 20;
end
